    ...
    <div class="shadow-md bg-red-300 rounded-lg px-8 pt-6 pb-8 mb-4 w-1/2 divide-blue-200 divide-y">
      ...
      <div>
        ...
        <div class="py-2">
          ...
          <input type="file" name="image" @change="handleFileUpload" id="image" />
        </div>
        <div>
      ...
      <div class="text-center">
        <button
          class="bg-green-500 mt-8 hover:bg-green-900 text-white font-bold py-2 px-7 rounded-lg focus:outline-none focus:shadow-outline"
          @click="updateemployee()">Update Data</button>
      </div>
    </div>
  </div>
